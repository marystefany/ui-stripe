...
export function DropdownOption({ name, content: Content, backgroundHeight }) {
  ...
  }, [registerOption, id, registered, optionDimensions, updateOptionProps, deleteOptionById, backgroundHeight]);
  ...
  return (
    <motion.button
      ...
      onHouverStart={() => !window.isMobile && handleOpen()}
      onHouverEnd={() => !window.isMobile && handleClose()}
